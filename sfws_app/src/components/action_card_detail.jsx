...
{/* If action is from original */}
{chosen_action.og === 'Original' && 
<div>
                            <h4>2020 update</h4>
...
{/* If action is from extension */}

{chosen_action.og === 'Extension' && 
<h4><b>This is an action from the August 2022 action plan review.</b></h4>
